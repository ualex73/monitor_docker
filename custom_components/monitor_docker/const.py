...
DOCKER_MONITOR_LIST = {
    DOCKER_INFO_VERSION: ['Version', None, 'mdi:information-outline', None, None],  # noqa: E501
    DOCKER_INFO_CONTAINER_RUNNING: ['Containers Running', None, 'mdi:docker', None, None],  # noqa: E501
    DOCKER_INFO_CONTAINER_PAUSED: ['Containers Paused', None, 'mdi:docker', None, None],  # noqa: E501
    DOCKER_INFO_CONTAINER_STOPPED: ['Containers Stopped', None, 'mdi:docker', None, None],  # noqa: E501
    DOCKER_INFO_CONTAINER_TOTAL: ['Containers Total', None, 'mdi:docker', None, None],  # noqa: E501
    DOCKER_STATS_CPU_PERCENTAGE: ['CPU', '%', 'mdi:chip', None, 'measurement'],
    DOCKER_STATS_1CPU_PERCENTAGE: ['1CPU', '%', 'mdi:chip', None, 'measurement'],  # noqa: E501
    DOCKER_STATS_MEMORY: ['Memory', 'MB', 'mdi:memory', None, 'measurement'],
    DOCKER_STATS_MEMORY_PERCENTAGE: ['Memory (percent)', '%', 'mdi:memory', None, 'measurement'],  # noqa: E501
    DOCKER_INFO_IMAGES: ['Images', None, 'mdi:docker', None, None],
}

CONTAINER_MONITOR_LIST = {
    CONTAINER_INFO_STATE: ['State', None, 'mdi:checkbox-marked-circle-outline', None, None],  # noqa: E501
    CONTAINER_INFO_HEALTH: ['Health', None, 'mdi:heart-pulse', None, None],
    CONTAINER_INFO_STATUS: ['Status', None, 'mdi:checkbox-marked-circle-outline', None, None],  # noqa: E501
    CONTAINER_INFO_UPTIME: ['Up Time', '', 'mdi:clock', 'timestamp', None],
    CONTAINER_INFO_IMAGE: ['Image', None, 'mdi:information-outline', None, None],  # noqa: E501
    CONTAINER_STATS_CPU_PERCENTAGE: ['CPU', '%', 'mdi:chip', None, 'measurement'],  # noqa: E501
    CONTAINER_STATS_1CPU_PERCENTAGE: ['1CPU', '%', 'mdi:chip', None, 'measurement'],  # noqa: E501
    CONTAINER_STATS_MEMORY: ['Memory', 'MB', 'mdi:memory', None, 'measurement'],  # noqa: E501
    CONTAINER_STATS_MEMORY_PERCENTAGE: ['Memory (percent)', '%', 'mdi:memory', None, 'measurement'],  # noqa: E501
    CONTAINER_STATS_NETWORK_SPEED_UP: ['Network speed Up', 'kB/s', 'mdi:upload', None, 'measurement'],  # noqa: E501
    ...
    CONTAINER_STATS_NETWORK_TOTAL_UP: ['Network total Up', 'MB', 'mdi:upload', None, 'total_increasing'],  # noqa: E501
